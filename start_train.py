...
parser.add_argument("--data_home", type=str, default="/home/yo46/learning/decoding/TrustLLM/Kangaroo/data/datasets/")
...
LOCAL_CKPT_DATA = "/home/yo46/learning/decoding/TrustLLM/Kangaroo/EarlyExitAdapter/"
        ...
        --num_machines {nnodes} --num_processes {processes} --main_process_ip {MASTER_ADDR} \
            --main_process_port {MASTER_PORT+epoch} --machine_rank {rank} --mixed_precision=fp16 train.py \
                --start {epoch} --tmpdir {dst_dir} --cpdir {LOCAL_CKPT_DATA} \
                    --basepath /home/yo46/learning/decoding/TrustLLM/Kangaroo/vicuna-7b-v1.3/ --configpath ./data/vicuna_7B_config.json \
